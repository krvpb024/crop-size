  ...
  switch (action.type) {
    case _types.UPLOAD_IMAGES:
      return _objectSpread({}, state, {
        ...
        })), _toConsumableArray(state.uploadImages)).map(function (img, index) {
    ...
    case _types.REMOVE_UPLOADED_IMAGE:
      ...
      var clearCurrentImageOrNot = function clearCurrentImageOrNot(state) {
        ...
        else if (state.currentImage && state.currentImage.index === action.imageIndex) return null; // remove image will affect to image's index after action.imageIndex
...
},{}],"../components/imgDisplay.js":[function(require,module,exports) {
...
function _templateObject3() {
  var data = _taggedTemplateLiteral(["<img src=\"", "\" class=\"inner-container__img\">"]);
...
var imgDisplay = {
  ...
  showImageOrInstruction: function showImageOrInstruction(_ref) {
    ...
    return (0, _hybrids.html)(_templateObject3(), currentImage.src);
  },
  render: function render(_ref2) {
    var currentImage = _ref2.currentImage,
        showImageOrInstruction = _ref2.showImageOrInstruction;
    return (0, _hybrids.html)(_templateObject4(), showImageOrInstruction).style(style);
  }
};
exports.imgDisplay = imgDisplay;
(0, _hybrids.define)('img-display', imgDisplay);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../utils/factories":"../utils/factories.js","../store":"../store/index.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../components/imgInfo.js":[function(require,module,exports) {
