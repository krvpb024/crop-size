...
},{"_css_loader":"../../node_modules/parcel/src/builtins/css-loader.js"}],"../../node_modules/hybrids/esm/utils.js":[function(require,module,exports) {
"use strict";
...
},{"./utils":"../../node_modules/hybrids/esm/utils.js"}],"../../node_modules/hybrids/esm/cache.js":[function(require,module,exports) {
"use strict";
...
},{"./utils":"../../node_modules/hybrids/esm/utils.js"}],"../../node_modules/hybrids/esm/define.js":[function(require,module,exports) {
...
},{"../define":"../../node_modules/hybrids/esm/define.js","./core":"../../node_modules/hybrids/esm/template/core.js","./resolve":"../../node_modules/hybrids/esm/template/resolve.js"}],"../../node_modules/hybrids/esm/index.js":[function(require,module,exports) {
"use strict";
...
var connect = function connect(store, mapState) {
  return {
    get: mapState ? function () {
...
},{"symbol-observable":"../../node_modules/symbol-observable/es/index.js"}],"../store/types.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.UPDATE_BOUNDING_BOX = exports.UPDATE_CURRENT_IMAGE_SIZE = exports.REMOVE_UPLOADED_IMAGE = exports.UPDATE_CURRENT_IMAGE = exports.UPLOAD_IMAGES = void 0;
var UPLOAD_IMAGES = 'UPLOAD_IMAGES';
exports.UPLOAD_IMAGES = UPLOAD_IMAGES;
var UPDATE_CURRENT_IMAGE = 'UPDATE_CURRENT_IMAGE';
exports.UPDATE_CURRENT_IMAGE = UPDATE_CURRENT_IMAGE;
var REMOVE_UPLOADED_IMAGE = 'REMOVE_UPLOADED_IMAGE';
exports.REMOVE_UPLOADED_IMAGE = REMOVE_UPLOADED_IMAGE;
var UPDATE_CURRENT_IMAGE_SIZE = 'UPDATE_CURRENT_IMAGE_SIZE';
exports.UPDATE_CURRENT_IMAGE_SIZE = UPDATE_CURRENT_IMAGE_SIZE;
var UPDATE_BOUNDING_BOX = 'UPDATE_BOUNDING_BOX';
exports.UPDATE_BOUNDING_BOX = UPDATE_BOUNDING_BOX;
},{}],"../store/reducers.js":[function(require,module,exports) {
"use strict";
...
var reorderIndex = function reorderIndex(img, index) {
...
var imageReducer = function imageReducer() {
  ...
  switch (action.type) {
    case _types.UPLOAD_IMAGES:
      return _objectSpread({}, state, {
        uploadImages: [].concat(_toConsumableArray(action.uploadImages.map(function (img) {
          return {
            src: img
          };
        })), _toConsumableArray(state.uploadImages)).map(reorderIndex)
      });

    case _types.UPDATE_CURRENT_IMAGE:
      return _objectSpread({}, state, {
        boundingBox: null,
        currentImage: action.currentImage
      });

    case _types.REMOVE_UPLOADED_IMAGE:
      var uploadImages = state.uploadImages.filter(function (item, index) {
        return index !== action.imageIndex;
      }).map(reorderIndex);

      var clearCurrentImageOrNot = function clearCurrentImageOrNot(state) {
        if (!state.currentImage) return null;
        if (state.uploadImages.length === 0) return null; // if the removed one is currentImage should clear
        else if (state.currentImage.index === action.imageIndex) return null; // remove image will affect to image's index after action.imageIndex

        return action.imageIndex < state.currentImage.index ? _objectSpread({}, state.currentImage, {
          index: state.currentImage.index - 1
        }) : state.currentImage;
      };
    ...
    case _types.UPDATE_CURRENT_IMAGE_SIZE:
      return _objectSpread({}, state, {
        imageSize: action.imageSize
      });

    case _types.UPDATE_BOUNDING_BOX:
      return _objectSpread({}, state, {
...
},{"./types":"../store/types.js"}],"../store/index.js":[function(require,module,exports) {
"use strict";
...
var store = (0, _redux.createStore)(_reducers.imageReducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
/* eslint-enable */

exports.store = store;
},{"redux":"../../node_modules/redux/es/redux.js","./reducers":"../store/reducers.js"}],"../store/actions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateBoundingBox = exports.updateCurrentImageSize = exports.removeUploadedImage = exports.updateCurrentImage = exports.uploadImages = void 0;

var _types = require("./types");

var uploadImages = function uploadImages(_uploadImages) {
  return {
    type: _types.UPLOAD_IMAGES,
...
var updateCurrentImage = function updateCurrentImage(currentImage) {
  return {
    type: _types.UPDATE_CURRENT_IMAGE,
...
var removeUploadedImage = function removeUploadedImage(imageIndex) {
  return {
    type: _types.REMOVE_UPLOADED_IMAGE,
...
var updateCurrentImageSize = function updateCurrentImageSize(imageSize) {
  return {
    type: _types.UPDATE_CURRENT_IMAGE_SIZE,
    imageSize: imageSize
  };
};

exports.updateCurrentImageSize = updateCurrentImageSize;

var updateBoundingBox = function updateBoundingBox(boundingBox) {
  return {
    type: _types.UPDATE_BOUNDING_BOX,
    boundingBox: boundingBox
  };
};

exports.updateBoundingBox = updateBoundingBox;
},{"./types":"../store/types.js"}],"../../node_modules/parcel/src/builtins/_empty.js":[function(require,module,exports) {

},{}],"../components/imgCanvas.js":[function(require,module,exports) {
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n        <rect x=\"", "\" y=\"", "\" width=\"", "\" height=\"", "\" stroke=\"blue\" fill=\"purple\" fill-opacity=\"0.5\" stroke-opacity=\"0.8\"/>\n      "]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n    <svg class=\"img-canvas\" onclick=\"", "\" onmousemove=\"", "\">\n      ", "\n    </svg>\n    <style>\n    .img-canvas {\n      width: ", "px;\n      height: ", "px;\n    }\n    </style>\n  "]);
...
var getMousePositionRelativeToElemet = function getMousePositionRelativeToElemet(element) {
...
var onclickHandler = function onclickHandler(host, e) {
  var _getMousePositionRela = getMousePositionRelativeToElemet(e),
      _getMousePositionRela2 = _slicedToArray(_getMousePositionRela, 2),
      x = _getMousePositionRela2[0],
      y = _getMousePositionRela2[1];
  ...
  if (host.cropping !== 'start') {
    ...
    _store.store.dispatch((0, _actions.updateBoundingBox)(host.normalizedBoundingBox));
  }
};

var onmousemoveHandler = function onmousemoveHandler(host, e) {
  if (host.cropping !== 'start') return;

  var _getMousePositionRela3 = getMousePositionRelativeToElemet(e),
      _getMousePositionRela4 = _slicedToArray(_getMousePositionRela3, 2),
      x = _getMousePositionRela4[0],
      y = _getMousePositionRela4[1];
...
var fixToOne = function fixToOne(num) {
...
var ImgCanvas = {
  // props
  displayImage: {
    set: function set(host, value, lastValue) {
      host.cropping = 'stop';
      return value;
    }
  },
  ...
  boundingBox: function boundingBox(_ref) {
    ...
    var x = fixToOne(Math.min(startPosition.x, mousePosition.x));
    var y = fixToOne(Math.min(startPosition.y, mousePosition.y));
    var endX = fixToOne(Math.max(startPosition.x, mousePosition.x));
    var endY = fixToOne(Math.max(startPosition.y, mousePosition.y));
    var width = fixToOne(endX - x);
    var height = fixToOne(endY - y);
    return {
      x: x,
      y: y,
      endX: endX,
  ...
  normalizedBoundingBox: function normalizedBoundingBox(_ref2) {
    var _ref2$boundingBox = _ref2.boundingBox,
        x = _ref2$boundingBox.x,
        y = _ref2$boundingBox.y,
        endX = _ref2$boundingBox.endX,
        endY = _ref2$boundingBox.endY,
        width = _ref2$boundingBox.width,
        height = _ref2$boundingBox.height;

    var _store$getState$image = _store.store.getState().imageSize,
        offsetWidth = _store$getState$image.offsetWidth,
        offsetHeight = _store$getState$image.offsetHeight;
  ...
  render: function render(_ref3) {
    var displayImage = _ref3.displayImage,
        cropping = _ref3.cropping,
        _ref3$boundingBox = _ref3.boundingBox,
        x = _ref3$boundingBox.x,
        y = _ref3$boundingBox.y,
        width = _ref3$boundingBox.width,
        height = _ref3$boundingBox.height;
    return (0, _hybrids.html)(_templateObject(), onclickHandler, onmousemoveHandler, cropping !== 'stop' && (0, _hybrids.svg)(_templateObject2(), x, y, width, height), displayImage.offsetWidth, displayImage.offsetHeight).style(style);
  }
};
(0, _hybrids.define)('img-canvas', ImgCanvas);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../store":"../store/index.js","../store/actions":"../store/actions.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../components/imgDisplay.js":[function(require,module,exports) {
...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["\n          <img-canvas displayImage=\"", "\"></img-canvas>\n        "]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<p>Please Select an Image Below</p>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<p>Please Upload Images Below</p>"]);
...
var style = ".img-display {\n  padding: 10px;\n  box-sizing: border-box;\n  height: 100%;\n}\n\n.img-display__inner-container {\n  height: 100%;\n  width: 100%;\n  position: relative;\n  background-color: rgba(128, 128, 128, .3);\n}\n\n.inner-container__img {\n  height: auto;\n  width: auto;\n  object-fit: contain;\n  max-width: 100%;\n  max-height: 100%;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n\np {\n  margin: 0;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}";
var imgDisplay = {
  currentImage: (0, _factories.connect)(_store.store, function (state) {
    return state.currentImage;
  }),
  uploadImages: (0, _factories.connect)(_store.store, function (state) {
    return state.uploadImages;
  }),
  showImageOrInstruction: function showImageOrInstruction(_ref) {
    var currentImage = _ref.currentImage,
        uploadImages = _ref.uploadImages;
    if (uploadImages.length === 0) return (0, _hybrids.html)(_templateObject());else if (!currentImage) return (0, _hybrids.html)(_templateObject2());
    return (0, _hybrids.html)(_templateObject3(), currentImage.src, function (host) {
      (0, _hybrids.dispatch)(host, 'imgLoaded');
    });
  },
  displayImage: {
    connect: function connect(host, key) {
      host.addEventListener('imgLoaded', function () {
        var imgElement = host.shadowRoot.querySelector('.inner-container__img');
        ...
        if (imgElement) {
          ...
          _store.store.dispatch((0, _actions.updateCurrentImageSize)(host[key]));
        } else {
          host[key] = null;
        }
      });
  ...
  render: function render(_ref2) {
    var showImageOrInstruction = _ref2.showImageOrInstruction,
        displayImage = _ref2.displayImage,
        currentImage = _ref2.currentImage;
    return (0, _hybrids.html)(_templateObject4(), showImageOrInstruction, currentImage && displayImage ? (0, _hybrids.html)(_templateObject5(), displayImage) : '').style(style);
  }
};
exports.imgDisplay = imgDisplay;
(0, _hybrids.define)('img-display', imgDisplay);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../utils/factories":"../utils/factories.js","../store":"../store/index.js","./imgCanvas":"../components/imgCanvas.js","../store/actions":"../store/actions.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../components/imgInfo.js":[function(require,module,exports) {
...
var ImgInfo = {
  imageSize: (0, _factories.connect)(_store.store, function (state) {
    return state.imageSize;
  }),
  boundingBox: (0, _factories.connect)(_store.store, function (state) {
    return state.boundingBox;
  }),
  cropSize: function cropSize(_ref) {
  ...
  render: function render(_ref2) {
    var cropSize = _ref2.cropSize,
        imageSize = _ref2.imageSize;
    return (0, _hybrids.html)(_templateObject(), imageSize ? (0, _hybrids.html)(_templateObject2(), imageSize.naturalWidth, imageSize.naturalHeight) : (0, _hybrids.html)(_templateObject3()), cropSize && (0, _hybrids.html)(_templateObject4(), cropSize.width, cropSize.height));
  }
};
exports.ImgInfo = ImgInfo;
(0, _hybrids.define)('img-info', ImgInfo);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../store":"../store/index.js","../utils/factories":"../utils/factories.js"}],"../assets/icon/square-upload.svg":[function(require,module,exports) {
module.exports = "/square-upload.29d36cf1.svg";
},{}],"../components/imgUploader.js":[function(require,module,exports) {
...
var _squareUpload = _interopRequireDefault(require("../assets/icon/square-upload.svg"));
...
var style = ".img-uploader {\n  box-sizing: border-box;\n  height: 100%;\n  padding: 10px;\n}\n\n.img-uploader__dropzone {\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: 1px solid #000;\n  border-radius: 10px;\n}\n\n.img-uploader__dropzone:hover {\n  background-color: rgba(0, 0, 0, .1);\n}\n\np {\n  margin: 0;\n  text-align: center;\n}\n\n.img-uploader__dropzone--active {\n  background-color: rgba(0, 0, 0, .1);\n  color: white;\n}";

var dragoverHandler = function dragoverHandler(host, e) {
  e.preventDefault();
  host.dragoverActive = true;
};

var dragleaveHandler = function dragleaveHandler(host, e) {
  host.dragoverActive = false;
};

var transferFileToDataUrl = function transferFileToDataUrl(file) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(host, ev) {
    var isImageType, files, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            isImageType = function isImageType(file) {
              return file.type.startsWith('image/');
            };

            files = Array.from(ev.dataTransfer.files).filter(isImageType);
            _context.next = 8;
            return Promise.all(files.map(transferFileToDataUrl));

          case 8:
            result = _context.sent;

            _store.store.dispatch((0, _actions.uploadImages)(result));
  ...
  return function dropHandler(_x, _x2) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(host, e) {
    var files, result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            files = Array.from(host.shadowRoot.querySelector('.dropzone__input').files);
            _context2.next = 3;
            return Promise.all(files.map(transferFileToDataUrl));
  ...
  return function onchangeHander(_x3, _x4) {
...
var ImgUploader = {
  ...
  render: function render(_ref3) {
    var dragoverActive = _ref3.dragoverActive;
    return (0, _hybrids.html)(_templateObject(), {
      'img-uploader__dropzone': true,
      'img-uploader__dropzone--active': dragoverActive
    }, dropHandler, dragoverHandler, dragleaveHandler, _squareUpload.default, onchangeHander).style(style);
  }
};
(0, _hybrids.define)('img-uploader', ImgUploader);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../store":"../store/index.js","../store/actions":"../store/actions.js","../assets/icon/square-upload.svg":"../assets/icon/square-upload.svg","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../assets/icon/ic_close_18px.svg":[function(require,module,exports) {
module.exports = "/ic_close_18px.c59bb94c.svg";
},{}],"../components/imgSwiperItem.js":[function(require,module,exports) {
...
exports.ImgSwiperItem = void 0;

var _hybrids = require("hybrids");

var _factories = require("../utils/factories");

var _ic_close_18px = _interopRequireDefault(require("../assets/icon/ic_close_18px.svg"));
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n    <div class=\"img-item\" onclick=\"", "\">\n      <img src=\"", "\" class=\"img-item__image\">\n      <button class=\"img-item__close-button\" onclick=\"", "\">\n        <img src=\"", "\">\n      </button>\n    </div>\n  "]);
...
var style = ".img-item {\n  box-sizing: border-box;\n  min-width: 100px;\n  max-width: 100px;\n  height: 100%;\n  padding: 10px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n  cursor: pointer;\n}\n\n.img-item--active {\n  border: 1px solid #000;\n}\n\n.img-item__image {\n  object-fit: contain;\n  width: 100%;\n  height: 100%;\n}\n\n.img-item__close-button {\n  position: absolute;\n  border: none;\n  background-color: black;\n  top: 5%;\n  right: 5%;\n  padding: 0;\n  width: 18px;\n  height: 18px;\n  border-radius: 50%;\n  display: none;\n}\n\n.img-item__close-button:active {\n  background-color: rgba(0, 0, 0, .5);\n}\n\n.img-item:hover .img-item__close-button {\n  display: block;\n}";

var updateCurrentImageHandler = function updateCurrentImageHandler(host) {
  if (host.image === host.currentImage) return;

  _store.store.dispatch((0, _actions.updateCurrentImage)(host.image));
};

var removeUploadedImageHandler = function removeUploadedImageHandler(host, e) {
  e.stopPropagation();

  _store.store.dispatch((0, _actions.removeUploadedImage)(host.image.index));
};
...
var ImgSwiperItem = {
  ...
  render: function render(_ref) {
    ...
    return (0, _hybrids.html)(_templateObject(), updateCurrentImageHandler, image.src, removeUploadedImageHandler, _ic_close_18px.default).style(style);
  }
};
exports.ImgSwiperItem = ImgSwiperItem;
(0, _hybrids.define)('img-swiper-item', ImgSwiperItem);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../utils/factories":"../utils/factories.js","../assets/icon/ic_close_18px.svg":"../assets/icon/ic_close_18px.svg","../store":"../store/index.js","../store/actions":"../store/actions.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../components/imgSwiper.js":[function(require,module,exports) {
...
exports.ImgSwiper = void 0;

var _hybrids = require("hybrids");

var _store = require("../store");

require("./imgSwiperItem");
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n        <img-swiper-item image=\"", "\"></img-swiper-item>\n        "]);
...
var style = ".img-swiper {\n  background-color: rgba(128, 128, 128, 0.3);\n  margin: 10px;\n  box-sizing: border-box;\n  height: calc(100% - 20px);\n  width: calc(100% - 20px);\n  padding: 10px;\n}\n\n.img-swiper__inner-container {\n  box-sizing: border-box;\n  display: flex;\n  width: auto;\n  height: 100%;\n  overflow-x: auto;\n}\n";
var ImgSwiper = {
  uploadImages: (0, _factories.connect)(_store.store, function (state) {
    return state.uploadImages;
  }),
  render: function render(_ref) {
    var uploadImages = _ref.uploadImages;
    return (0, _hybrids.html)(_templateObject(), uploadImages.map(function (img) {
      return (0, _hybrids.html)(_templateObject2(), img);
    })).style(style);
  }
};
exports.ImgSwiper = ImgSwiper;
(0, _hybrids.define)('img-swiper', ImgSwiper);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../store":"../store/index.js","./imgSwiperItem":"../components/imgSwiperItem.js","../utils/factories":"../utils/factories.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"index.js":[function(require,module,exports) {
...
require("../components/imgDisplay");

require("../components/imgInfo");

require("../components/imgUploader");

require("../components/imgSwiper");
