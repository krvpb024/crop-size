...
exports.REMOVE_UPLOADED_IMAGE = exports.UPDATE_CURRENT_IMAGE = exports.UPLOAD_IMAGES = void 0;
...
exports.store = store;
},{"redux":"../../node_modules/redux/es/redux.js","./reducers":"../store/reducers.js"}],"../../node_modules/parcel/src/builtins/_empty.js":[function(require,module,exports) {
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<circle cx=\"", "\" cy=\"", "\" r=\"", "\" />"]);
...
var onclickHandler = function onclickHandler(host, e) {
  ...
  console.log(x, y); // host.crops = [...host.crops, { cx: 50, cy: 60, r: 90 }]
};
...
var ImgCanvas = {
  ...
  render: function render(_ref) {
    var displayImage = _ref.displayImage,
        crops = _ref.crops;
    return (0, _hybrids.html)(_templateObject(), onclickHandler, crops.map(function (_ref2) {
      var cx = _ref2.cx,
          cy = _ref2.cy,
          r = _ref2.r;
      return (0, _hybrids.svg)(_templateObject2(), cx, cy, r);
    }), displayImage.offsetWidth, displayImage.offsetHeight).style(style);
  }
};
(0, _hybrids.define)('img-canvas', ImgCanvas);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../components/imgDisplay.js":[function(require,module,exports) {
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<p>Please Select an Image</p>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<p>Please Upload Images</p>"]);
...
var imgDisplay = {
  ...
  render: function render(_ref2) {
    ...
    return (0, _hybrids.html)(_templateObject4(), showImageOrInstruction, displayImage ? (0, _hybrids.html)(_templateObject5(), displayImage) : '').style(style);
  }
};
exports.imgDisplay = imgDisplay;
(0, _hybrids.define)('img-display', imgDisplay);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../utils/factories":"../utils/factories.js","../store":"../store/index.js","./imgCanvas":"../components/imgCanvas.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../components/imgInfo.js":[function(require,module,exports) {
...
},{"hybrids":"../../node_modules/hybrids/esm/index.js"}],"../store/actions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeUploadedImage = exports.updateCurrentImage = exports.uploadImages = void 0;
...
},{"./types":"../store/types.js"}],"../components/imgUploader.js":[function(require,module,exports) {
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(host, ev) {
    var isImageType, files, transferFileToDataUrl, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            transferFileToDataUrl = function transferFileToDataUrl(file) {
...
var ImgUploader = {
  ...
  render: function render(_ref2) {
    var dragoverActive = _ref2.dragoverActive;
    return (0, _hybrids.html)(_templateObject(), {
      'img-uploader__dropzone': true,
      'img-uploader__dropzone--active': dragoverActive
    }, dropHandler, dragoverHandler, dragleaveHandler).style(style);
  }
};
(0, _hybrids.define)('img-uploader', ImgUploader);
},{"hybrids":"../../node_modules/hybrids/esm/index.js","../store":"../store/index.js","../store/actions":"../store/actions.js","fs":"../../node_modules/parcel/src/builtins/_empty.js"}],"../assets/icon/ic_close_18px.svg":[function(require,module,exports) {
...
},{"hybrids":"../../node_modules/hybrids/esm/index.js","fs":"../../node_modules/parcel/src/builtins/_empty.js","../assets/icon/ic_close_18px.svg":"../assets/icon/ic_close_18px.svg","../store":"../store/index.js","../store/actions":"../store/actions.js"}],"../components/imgSwiper.js":[function(require,module,exports) {
